...
(function() {
  ...
  var demoContent = [
    {
      demo_link: 'https://huangshunq.github.io/Youth-League-committee-webpage/index.html',
      img_link: 'https://huangshunq.github.io/Youth-League-committee-webpage/img/logo.svg',
      code_link: 'https://github.com/Huangshunq/Youth-League-committee-webpage',
      title: '校团委网页设计大赛参赛作品',
      core_tech: 'HTML & CSS',
      description: '校团委网页设计大赛参赛作品，一个静态页面，兼容IE9 <a href =""></a>。'
    }//, {
